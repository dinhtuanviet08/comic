...
namespace ComicSystem.Controllers
{
    public class ComicBooksController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var comicBook = await _context.ComicBooks.FirstOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Author,PricePerDay")] ComicBook comicBook)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Author,PricePerDay")] ComicBook comicBook)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ComicBookExists(comicBook.Id)) return NotFound();
                    else throw;
                }
                return RedirectToAction(nameof(Index));
            }
